...
interface DetailGuruAdminProps {
  user: User;
  onLogout: () => void;
  currentPage: string;
  onMenuClick: (page: string) => void;
  guruId: string; // ID guru yang akan ditampilkan
  onNavigateToRiwayat: (guruId: string) => void; // Callback untuk navigasi ke riwayat
}
...
export default function DetailGuruAdmin({
  user,
  onLogout,
  currentPage,
  onMenuClick,
